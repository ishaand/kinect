...
namespace TextureDemo
{
    ...
    /// </summary>
    public class TextureDemoGame : Microsoft.Xna.Framework.Game
    {
        ...
        int kinectVideoWidth = 640;
        int kinectVideoHeight = 480;
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            kinectVideoTexture = new Texture2D(GraphicsDevice, kinectVideoWidth, kinectVideoHeight);
            Color[] bitmap = new Color[kinectVideoWidth * kinectVideoHeight];

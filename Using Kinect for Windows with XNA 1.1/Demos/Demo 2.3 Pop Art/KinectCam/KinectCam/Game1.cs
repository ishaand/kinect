...
namespace KinectCam
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        Color[] popArtColors = new Color[] { 
            Color.Red, Color.Green, Color.Blue, Color.Yellow, Color.Purple, Color.Orange, Color.Cyan, Color.Magenta};
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            {
                int panelWidth = GraphicsDevice.Viewport.Width / noOfPanels;
                int panelHeight = GraphicsDevice.Viewport.Height / noOfPanels;

                int colorPos = 0;

                for (int x = 0; x < noOfPanels; x++)
                {
                    for (int y = 0; y < noOfPanels; y++)
                    {
                        Rectangle destRectangle = new Rectangle(
                            x * panelWidth, y * panelHeight,
                            panelWidth, panelHeight);
                        spriteBatch.Draw(kinectVideoTexture, destRectangle, null, popArtColors[colorPos]);
                        colorPos++;
                        if (colorPos == popArtColors.Length) colorPos = 0;
                    }
                }
            }
